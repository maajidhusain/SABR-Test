...
export const mockMembers: MemberProfile[] = [
  {
    ...
    masjidAffiliation: "Islamic Center of Naperville",
    additionalCredentials: "PMP Certification, 2020",
    organizationWebsite: "https://lakeshore-logistics.example/careers",
    industryExperience: "Logistics & Operations, 12 years",
    wantsResume: false,
    resumePath: null
  },
  {
    ...
    contactVisibility: "directory",
    institutions: "University of Illinois at Chicago College of Dentistry",
    masjidAffiliation: "Masjid Al-Huda Skokie",
    additionalCredentials: null,
    organizationWebsite: "https://brightpath.example",
    industryExperience: "Healthcare / Dentistry, 8 years",
    wantsResume: false,
    resumePath: null
  },
  {
    ...
    masjidAffiliation: "IEC Hussaini Chicago",
    additionalCredentials: "MBA Candidate, 2027",
    organizationWebsite: "https://mhtech.example/jobs",
    industryExperience: "Software Engineering / Health Tech, 6 years",
    wantsResume: true,
    resumePath: "member-profiles/user-3/resume.pdf"
  },
  {
    id: "member-4",
    profileId: "user-4",
    ...
    masjidAffiliation: "Baitul Ilm Academy",
    additionalCredentials: null,
    organizationWebsite: "https://cityline.example",
    industryExperience: "Commercial Real Estate, 9 years",
    wantsResume: false,
    resumePath: null
  }
];
...
export const mockJobListings: JobListing[] = [
  {
    ...
    company: "Sabr Fulfillment Partners",
    industry: "Logistics",
    experienceLevel: "mid",
    location: "Aurora, IL",
    type: "full-time",
    description: "Join a growing community-owned logistics business managing vendor relationships, inventory workflows, and procurement coordination.",
    contactEmail: "contact@sabrfulfillment.example",
    applicationUrl: null,
    status: "approved",
    requestedBy: "user-1",
  ...
  },
  {
    ...
    location: "Skokie, IL",
    type: "full-time",
    description: "Part-time and full-time openings available. Looking for a detail-oriented coordinator to manage scheduling, patient communications, and front-desk operations.",
    contactEmail: "hello@brightpath.example",
    applicationUrl: null,
    status: "approved",
    requestedBy: "user-2",
  ...
  {
    id: "job-3",
    title: "Commercial Lease Analyst",
    company: "Cityline Advisors",
    industry: "Real Estate",
    experienceLevel: "mid",
    location: "Oak Brook, IL",
    type: "full-time",
    description: "Support site selection and lease negotiation for retail clients expanding across Chicagoland. Experience with commercial real estate preferred.",
    contactEmail: "info@cityline.example",
    applicationUrl: null,
    status: "approved",
    requestedBy: "user-4",
  ...
  },
  {
    ...
    company: "Midwest Health Tech",
    industry: "Technology",
    experienceLevel: "internship",
    location: "Chicago, IL",
    type: "internship",
    description: "Summer internship for students interested in health tech. Work on product engineering, data systems, and automation tools used by care teams.",
    contactEmail: "careers@mhtech.example",
    applicationUrl: null,
    status: "pending",
    requestedBy: "user-3",
  ...
  {
    id: "job-5",
    title: "Attorney — Business & Contracts",
    company: "Rizvi Legal Group",
    industry: "Legal",
    experienceLevel: "senior",
    location: "Skokie, IL",
    type: "full-time",
    description: "Seeking an experienced attorney for business law, contracts, and advisory work for small-to-mid sized clients across the Chicagoland area.",
    contactEmail: "jawad.rizvi@firmexample.com",
    applicationUrl: null,
    status: "approved",
    requestedBy: "user-7",
    requestedAt: "2026-04-22",
